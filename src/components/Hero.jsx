    ...
    <section id="home" className="hero">
      <div className="container hero-container">
        <div className="hero-content">
          ...
          <h3 className="hero-title">Aspiring Full Stack Developer | AI/ML Enthusiast | Computer Science Student</h3>
          <p className="hero-description">
            A motivated Computer Science undergraduate with expertise in building scalable web applications. 
            Combining strong technical skills in React.js, Node.js, and Python with a passion for innovative solutions. 
            Currently maintaining an 8.46 CGPA while actively developing impactful projects.
          </p>
